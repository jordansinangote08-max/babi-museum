...
function foyerScreen() {
  return `<section class="foyer"><div class="foyer-inner">
    ...
    <small style="margin-top:22px">Curated by Jordan · For one visitor only.</small>
  </div></section>`;
}
...
function finalScreen() {
  return `<section class="final-screen final-cinematic"><div class="final-light"></div><div class="final-copy"><h1>MUSEUM OF US</h1><p>Thank you for visiting, Babi.</p><b>Curated by Jordan</b><small>For one visitor only.</small></div></section>`;
}
...
function injectPolishStyles() {
  if (document.querySelector('#museum-polish-v2')) return;
  const style = document.createElement('style');
  style.id = 'museum-polish-v2';
  style.textContent = `
    .room-plaque{display:inline-flex;align-items:center;gap:10px;margin-top:18px;padding:9px 12px;border:1px solid color-mix(in srgb,var(--wine) 34%,transparent);border-radius:999px;background:color-mix(in srgb,var(--paper,#f5ead8) 90%,white);box-shadow:0 8px 24px rgba(74,35,35,.08);letter-spacing:.12em;text-transform:uppercase}
    .room-plaque span{font-size:.68rem;font-weight:800;color:var(--wine)}.room-plaque small{font-size:.6rem;letter-spacing:.08em;opacity:.62}
    .micro-progress{display:flex;justify-content:center;gap:6px;margin:20px auto 0;max-width:360px}.micro-progress i{width:6px;height:6px;border-radius:50%;background:rgba(80,50,45,.16);transition:transform .35s ease,background .35s ease}.micro-progress i.done{background:var(--wine)}.micro-progress i.current{background:var(--wine);transform:scale(1.7);box-shadow:0 0 0 5px rgba(95,24,39,.08)}
    .now-playing-toast{position:fixed;top:74px;right:14px;z-index:1200;max-width:min(72vw,290px);padding:10px 13px;border-radius:14px;background:rgba(40,27,25,.92);color:#fff;box-shadow:0 14px 36px rgba(0,0,0,.22);backdrop-filter:blur(10px);animation:npIn .28s ease both}.now-playing-toast span{display:block;font-size:.56rem;letter-spacing:.18em;opacity:.65}.now-playing-toast strong{display:block;margin-top:3px;font-size:.82rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}@keyframes npIn{from{opacity:0;transform:translateY(-8px) scale(.97)}to{opacity:1;transform:none}}
    .gallery-shell{position:relative;overflow:hidden;border-radius:28px;background:var(--gallery-tone,#eadcc8);box-shadow:0 24px 70px rgba(55,31,26,.15);transition:background-color .7s ease,box-shadow .45s ease}.gallery-shell:before{content:'';position:absolute;inset:10px;z-index:6;border:1px solid rgba(255,255,255,.52);border-radius:20px;pointer-events:none;box-shadow:inset 0 0 0 1px rgba(57,37,31,.08)}
    .gallery-slide{position:relative;perspective:1000px}.gallery-slide img{transform:translateZ(0) scale(1.015);transition:transform 1.1s cubic-bezier(.22,.72,.2,1),filter .7s ease;filter:saturate(.94) contrast(.98)}.gallery-slide:after{content:'';position:absolute;inset:0;pointer-events:none;background:linear-gradient(180deg,rgba(255,255,255,.08),transparent 32%,rgba(20,10,8,.08));mix-blend-mode:soft-light}.gallery-shell:hover .gallery-slide img{transform:scale(1.025)}
    @media (pointer:fine){.gallery-slide img{transform:translate3d(calc(var(--px,0)*-4px),calc(var(--py,0)*-3px),0) scale(1.02)}}
    .ambient-6 .room-ambience:before,.ambient-6 .room-ambience:after{content:'';position:absolute;inset:-10%;pointer-events:none;background:radial-gradient(ellipse at 20% 30%,rgba(255,255,255,.18),transparent 42%),radial-gradient(ellipse at 80% 70%,rgba(220,225,216,.18),transparent 44%);filter:blur(18px);animation:mistDrift 13s ease-in-out infinite alternate}.ambient-6 .room-ambience:after{animation-duration:17s;animation-direction:alternate-reverse;opacity:.55}@keyframes mistDrift{from{transform:translate3d(-2%,1%,0) scale(1)}to{transform:translate3d(3%,-1%,0) scale(1.04)}}
    .hoppers-sticker{animation:stickerFloat 5.8s ease-in-out infinite}.hoppers-sticker-b{animation-delay:-2.1s;animation-duration:6.7s}@keyframes stickerFloat{0%,100%{transform:translateY(0) rotate(-1deg)}50%{transform:translateY(-7px) rotate(1.3deg)}}
    .ambient-11 .song-card{position:relative;overflow:hidden}.ambient-11 .song-card:before{content:'';position:absolute;width:86px;height:86px;border-radius:50%;right:-30px;top:-24px;background:repeating-radial-gradient(circle,rgba(88,24,37,.16) 0 1px,transparent 2px 6px);opacity:.55;animation:vinylSpin 11s linear infinite;pointer-events:none}@keyframes vinylSpin{to{transform:rotate(360deg)}}
    .envelope,.sealed-letter{transition:transform .35s ease,box-shadow .35s ease}.envelope:hover,.sealed-letter:hover{transform:translateY(-4px) rotate(.25deg);box-shadow:0 18px 36px rgba(70,35,35,.14)}
    .future-frame{overflow:hidden;position:relative}.future-ghost{position:absolute;inset:16% 10%;opacity:.11;filter:blur(.3px);animation:futureBreath 8s ease-in-out infinite alternate}.future-0 .future-ghost{background:linear-gradient(180deg,transparent 48%,rgba(92,45,39,.65) 49% 51%,transparent 52%),radial-gradient(circle at 78% 38%,rgba(100,58,46,.55) 0 8%,transparent 9%)}.future-1 .future-ghost{background:linear-gradient(150deg,transparent 45%,rgba(80,53,48,.5) 46% 49%,transparent 50%)}.future-2 .future-ghost,.future-3 .future-ghost{background:linear-gradient(90deg,transparent 25%,rgba(72,54,52,.5) 26% 29%,transparent 30% 70%,rgba(72,54,52,.45) 71% 74%,transparent 75%)}.future-5 .future-ghost{border:2px solid rgba(76,48,44,.45);border-radius:44% 44% 30% 30%}.future-7 .future-ghost{border-radius:50%;box-shadow:22px 10px 0 0 rgba(72,50,44,.4),-18px 14px 0 0 rgba(72,50,44,.35)}.future-8 .future-ghost{background:linear-gradient(90deg,rgba(72,50,44,.35) 0 2px,transparent 2px 48%,rgba(72,50,44,.35) 48% 50%,transparent 50%)}@keyframes futureBreath{from{transform:translateY(2px) scale(.98)}to{transform:translateY(-4px) scale(1.02)}}
    .museum-hall-shell{perspective:1000px}.museum-pan{filter:drop-shadow(0 24px 34px rgba(40,24,20,.08))}.museum-wall{transform-origin:50% 100%;background:linear-gradient(180deg,rgba(255,255,255,.28),transparent 25%),var(--paper,#f5ead8)}.museum-wall:after{content:'';position:absolute;left:0;right:0;bottom:0;height:90px;background:linear-gradient(180deg,rgba(91,61,50,.025),rgba(58,36,31,.12));clip-path:polygon(0 30%,100% 8%,100% 100%,0 100%);pointer-events:none}.gallery-bench,.gallery-plant,.visitor-group{filter:drop-shadow(0 10px 10px rgba(40,25,22,.11))}
    .memory-glow:before{content:'';position:fixed;inset:60px 0 0;pointer-events:none;background:radial-gradient(circle at 50% 24%,rgba(161,111,75,.075),transparent 42%);z-index:0}.memory-glow>*{position:relative;z-index:1}
    .final-cinematic{position:relative;overflow:hidden;isolation:isolate}.final-cinematic:before{content:'';position:absolute;inset:0;background:rgba(24,16,15,.12);animation:finalDim 5s ease forwards;pointer-events:none}.final-light{position:absolute;width:70vw;height:70vw;max-width:560px;max-height:560px;border-radius:50%;left:50%;top:44%;transform:translate(-50%,-50%);background:radial-gradient(circle,rgba(255,247,225,.8),rgba(255,244,220,.18) 44%,transparent 72%);filter:blur(8px);animation:finalLight 5.5s ease forwards}.final-copy{position:relative;z-index:2;animation:finalCopy 1.8s ease both}@keyframes finalDim{to{background:rgba(24,16,15,.26)}}@keyframes finalLight{from{opacity:.25;transform:translate(-50%,-50%) scale(1.12)}to{opacity:.75;transform:translate(-50%,-50%) scale(.9)}}@keyframes finalCopy{from{opacity:0;transform:translateY(12px)}to{opacity:1;transform:none}}
    .brand-button{appearance:none;border:0;background:none;padding:0;color:inherit;font:inherit;letter-spacing:inherit;cursor:pointer}
    @media (prefers-reduced-motion:reduce){.hoppers-sticker,.ambient-6 .room-ambience:before,.ambient-6 .room-ambience:after,.ambient-11 .song-card:before,.future-ghost,.final-cinematic:before,.final-light,.final-copy{animation:none!important}.gallery-slide img{transition:none!important}}
  `;
